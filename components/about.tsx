...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        After graduating with a degree in <span className="font-medium">Software Engineering</span>, I decided
        ...
        My core stack is <span className="font-medium">React, Next.js, Node.js, and MongoDB</span>. I am also
